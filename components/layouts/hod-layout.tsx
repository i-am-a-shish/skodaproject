...
import { Home, Building, Settings, Trophy, BarChart3, User, Bell, LogOut, Menu, X } from "lucide-react"
...
const navigation = [
  ...
  { name: "Department", href: "/hod/department", icon: Building },
                ...
                <Button variant="ghost" className="w-full justify-start p-2 h-auto">
                  <div className="flex items-center space-x-3">
                    <Avatar className="w-8 h-8">
                      <AvatarFallback className="bg-green-600 text-white">HD</AvatarFallback>
                    </Avatar>
                    <div className="text-left">
                      <p className="text-white text-sm font-medium">HOD</p>
                      <p className="text-gray-400 text-xs">Department Head</p>
                    </div>
                  </div>
                </Button>
              </DropdownMenuTrigger>
        ...
        <div className="sticky top-0 z-30 bg-gray-900/95 backdrop-blur-sm border-b border-gray-700">
          <div className="flex h-16 items-center justify-between px-6">
            ...
            <div className="flex items-center space-x-4">
              <Badge className="bg-green-600 text-white">156 Employees</Badge>
